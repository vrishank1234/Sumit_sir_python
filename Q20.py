...
def main():
    ...
    account1 = Account("123456789", "1234", 65000)
    account2 = Account("987654321", "5678", 5500)

    user1 = atm_system.add_user("Prem", [account1])
    user2 = atm_system.add_user("Piyush", [account2])
